class australia {
	...
	population[] = {
		{"NT",0},{"Stuart_Hwy",0},{"qld",0},{"nsw",1},{"vic",94},{"sa",0},{"Melbourne",1298},{"alice",507},{"Adelaide",1483},{"Perth",899},{"darwin",93},{"Brisbane",764},{"sydney",1857},{"West_australia",0},{"pinegap",83},{"Tasmania",223},{"hobart",80},{"Brisbane",764},{"Army Base",170},{"Phillip Island",0},{"Eden",245},{"King Island",0},{"Launceston",230},{"Mildura",378}
	};
	//Stuart_Hwy won't die
	disabledTowns[] = {"Stuart_Hwy"}; //no towns that need to be disabled
	antennas[] = {
